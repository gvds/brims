...
Create `/var/www/brims/.env` and populate it with the values for your environment. The minimum required settings are shown below.
...
APP_DEBUG=false
APP_URL=https://brims.example.com
...
MAIL_ENCRYPTION=tls
MAIL_FROM_ADDRESS=noreply@brims.example.com
MAIL_FROM_NAME="${APP_NAME}"

# Optional — S3-compatible object storage for large file uploads
# AWS_ACCESS_KEY_ID=
