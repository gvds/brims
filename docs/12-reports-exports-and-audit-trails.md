...
- Confirm filters and scope before export
- Check row counts and identifiers
- Verify status values and dates
- Confirm whether the export reflects the latest updates
