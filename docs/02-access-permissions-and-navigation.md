# Access, Permissions, and Navigation
...
- Review identifiers before saving changes
- Be cautious with status changes and locked records
- Check related records before deleting or detaching items

## Common Questions

- Why can I see a record but not edit it?
- Why is an action button missing?
- Why can I access one project but not another?
